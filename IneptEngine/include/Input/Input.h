...
namespace IneptEngine::Input
{
    ...
    public:
         ...
         */
        virtual std::map<Keyboard::Key, bool> GetKeyStates() = 0;
         ...
         */
        virtual void RegisterKeyCallback(Keyboard::Key key, std::function<void(int)> callback) = 0;
       /*
         * @brief Register a callback function to be called when any key is pressed.
         * @param callback The callback function to be called when a key is pressed. The function should take no parameters and return void.
         */
        virtual void RegisterAllKeyCallback(std::function<void(Keyboard::Key)> callback) = 0;
        /*
